...
const COURSES: CourseItem[] = [
  {
    url: 'http://localhost:3000/ifpisrn-horarios/docs/turma/ago2023',
    name: 'Técnico em Agropecuária Integrado ao ensino Médio',
    acronym: "AGO2023",
    showOnHomepage: true,
  },
  {
    url: 'http://localhost:3000/ifpisrn-horarios/docs/turma/com2023',
    name: 'Técnico em Comércio Integrado ao Ensino Médio',
    acronym: "COM2023",
    showOnHomepage: true,
  },
  {
    url: 'http://localhost:3000/ifpisrn-horarios/docs/turma/ein2023',
    name: 'Técnico em Eletromecânica Integrado ao Ensino Médio',
    acronym: "EIN023",
    showOnHomepage: true,
  },
  {
    url: 'http://localhost:3000/ifpisrn-horarios/docs/turma/iiw2023a',
    name: 'Técnico em Informática para Internet Integrado ao Ensino Médio',
    acronym: "IIW2023A",
    showOnHomepage: true,
  },
  {
    url: 'http://localhost:3000/ifpisrn-horarios/docs/turma/iiw2023b',
    name: 'Técnico em Informática para Internet Integrado ao Ensino Médio',
    acronym: "IIW2023B",
    showOnHomepage: true,
  },
